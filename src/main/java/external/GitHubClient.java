...
public class GitHubClient {
	...
	private List<Item> getItemList(JSONArray array) throws JSONException {
		...
		for (int i = 0; i < array.length(); i++) {
			...
			// doesn't retrun keywords.
			String description = 
					getStringFieldOrEmpty(array.getJSONObject(i), "description");
		...
		List<List<String>> keywords = MonkeyLearnClient.extractKeywords(descriptionList.toArray(
				new String[descriptionList.size()]));
